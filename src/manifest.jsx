...
export const categories = [
  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        subItems: [
          { id: 'tv1', label: 'Continue Watching', icon: Play, type: 'document', action: { type: 'details', description: 'Resume from where you left off', date: '' } },
          { id: 'tv2', label: 'New Releases', icon: Video, type: 'document', action: { type: 'details', description: 'Latest episodes', date: '' } },
          { id: 'tv3', label: 'My List', icon: Video, type: 'document', action: { type: 'details', description: 'Saved shows', date: '' } },
        ],
    ...
    items: [
      {
        ...
        subItems: [
          { id: 'g1-play', label: 'Play', icon: Play, type: 'application', action: { type: 'media', contentType: 'webgl', src: 'https://threejs.org/examples/games_fps.html' } },
          { id: 'g1-info', label: 'Game Info', icon: Info, type: 'document', action: { type: 'details', description: 'Fast-paced 3D runner built with Three.js', date: '' } },
          { id: 'g1-scores', label: 'High Scores', icon: Gamepad2, type: 'document', action: { type: 'details', description: 'No scores yet — be the first!', date: '' } },
        ],
      ...
      },
      {
        ...
        subItems: [
          { id: 'g2-play', label: 'Play', icon: Play, type: 'document', action: { type: 'details', description: 'Starting puzzle game…', date: '' } },
          { id: 'g2-levels', label: 'Level Select', icon: Puzzle, type: 'document', action: { type: 'details', description: '24 levels available', date: '' } },
        ],
  ...
  },
  {
    ...
    defaultIndex: 0,
    items: [
      { id: 'settings1', label: 'Display', icon: Sun, type: 'document', action: { type: 'details', description: 'Screen brightness, theme settings', date: '' } },
      { id: 'settings2', label: 'Audio', icon: Volume2, type: 'document', action: { type: 'details', description: 'Volume, sound effects', date: '' } },
      { id: 'settings3', label: 'Date/Time', icon: Clock, type: 'document', action: { type: 'details', description: 'Set date and time', date: '' } },
      { id: 'settings4', label: 'About', icon: Info, type: 'document', action: { type: 'details', description: 'XMB React v1.0.0', date: '2026' } },
    ],
  },
  {
    id: 'network',
